...
const questions: Question[] = [
  // ============ BEGINNER (1-35) ============
  {
    ...
    options: ["JavaScript framework", "Typed superset of JavaScript", "New programming language", "JavaScript compiler"],
  ...
  },
  {
    ...
    options: ["let x as number", "let x: number", "int x", "let x = number"],
    answer: "let x: number",
  ...
  },
  {
    ...
    options: ["int, float, char", "string, number, boolean, null, undefined", "str, num, bool", "String, Integer, Boolean"],
  ...
  },
  {
    ...
    options: ["number[]", "Array<number>", "Both are correct", "array[number]"],
  ...
  },
  {
    ...
    options: ["Error type", "Type that allows any value (opt-out of type-checking)", "Generic type", "Empty type"],
  ...
  },
  {
    ...
    options: ["Music tuple", "Array with fixed length and types", "Object type", "Function type"],
  ...
  },
  {
    ...
    options: ["object = {}", "{ name: string, age: number }", "Object<name, age>", "type: object"],
  ...
  },
  {
    ...
    options: ["UI interface", "Contract defining object structure", "Function type", "Variable type"],
  ...
  },
  {
    ...
    options: ["define interface", "interface Person { name: string }", "type interface", "create interface"],
  ...
  },
  {
    ...
    options: ["Variable alias", "Alternative name for a type using 'type'", "Import alias", "Function alias"],
  ...
  },
  {
    ...
    options: ["function add(a, b): number", "function add(a: number, b: number): number", "function add(number a, number b)", "function: number add(a, b)"],
  ...
  },
  {
    ...
    options: ["Required", "Optional", "Nullable", "Readonly"],
    answer: "Optional",
  ...
  },
  {
    ...
    options: ["Labor union", "Type that can be one of several types", "Combined type", "Merged type"],
  ...
  },
  {
    ...
    options: ["String literal", "Exact specific value as a type", "Template type", "Constant type"],
  ...
  },
  {
    ...
    options: ["Makes variable global", "Prevents modification after creation", "Makes public", "Makes private"],
  ...
  },
  {
    ...
    options: ["Empty variable", "Functions that don't return a value", "Null value", "Undefined value"],
  ...
  },
  {
    ...
    options: ["Never used", "Functions that never return or throw", "Impossible type", "Empty type"],
  ...
  },
  {
    ...
    options: ["Same as any", "Type-safe counterpart of any", "Undefined type", "Error type"],
  ...
  },
  {
    ...
    options: ["enum Color = { Red }", "enum Color { Red, Green }", "define enum Color", "type enum Color"],
  ...
  },
  {
    ...
    options: ["Explicit typing", "TypeScript automatically determines types", "Type conversion", "Type validation"],
  ...
  },
  {
    ...
    options: ["node file.ts", "tsc file.ts", "ts file.ts", "compile file.ts"],
    answer: "tsc file.ts",
  ...
  },
  {
    ...
    options: ["package.json", "tsconfig.json", "typescript.json", "config.ts"],
  ...
  },
  {
    ...
    options: ["Strict performance", "Enables all strict type-checking options", "Strict mode JS", "Strict compilation"],
  ...
  },
  {
    ...
    options: ["(string)value", "value as string", "<string>value", "Both B and C"],
    answer: "Both B and C",
  ...
  },
  {
    ...
    options: ["Security type", "Code that narrows type within a block", "Type validator", "Type protector"],
  ...
  },
  {
    ...
    options: ["Runtime type check only", "Both runtime check and type operator", "Type definition", "Type conversion"],
  ...
  },
  {
    ...
    options: ["Creating instances", "Checking if object is instance of class", "Type conversion", "Interface check"],
  ...
  },
  {
    ...
    options: ["function: type", "(a: number) => string", "func<number, string>", "function(number): string"],
  ...
  },
  {
    ...
    options: ["Adding exports", "Extending existing module declarations", "Module merge", "Import extension"],
  ...
  },
  {
    ...
    options: ["Data files", "Type definitions for JavaScript libraries", "Documentation", "Debug files"],
  ...
  },
  {
    ...
    options: ["Type library", "DefinitelyTyped package with type definitions", "Type checker", "Type validator"],
  ...
  },
  {
    ...
    options: ["Creates constant", "Narrows to literal types (const assertion)", "Type conversion", "Freeze object"],
  ...
  },
  {
    ...
    options: ["Array check only", "Property check and type narrowing", "In statement", "Container check"],
  ...
  },
  {
    ...
    options: ["Array index", "Define type for dynamic property keys", "Function signature", "Class signature"],
  ...
  },
  {
    ...
    options: ["interface B += A", "interface B extends A", "interface B : A", "interface B inherits A"],
  ...
  // ============ INTERMEDIATE (36-70) ============
  {
    ...
    options: ["General type", "Reusable component working with multiple types", "Universal type", "Default type"],
  ...
  },
  {
    ...
    options: ["function fn()", "function fn<T>(arg: T): T", "function fn(T arg)", "generic function fn"],
  ...
  },
  {
    ...
    options: ["Type limit", "Limiting what types can be used with generic", "Required generic", "Generic validation"],
  ...
  },
  {
    ...
    options: ["Object keys function", "Creates union of object's key types", "Key check", "Property list"],
  ...
  },
  {
    ...
    options: ["Runtime only", "Creates type from variable's type", "Type conversion", "Type checking"],
  ...
  },
  {
    ...
    options: ["Array map type", "Type that transforms properties of another type", "Object mapping", "Type conversion"],
  ...
  },
  {
    ...
    options: ["Creates partial", "Makes all properties optional", "Removes properties", "Creates subset"],
  ...
  },
  {
    ...
    options: ["Validates required", "Makes all properties required", "Checks requirements", "Adds requirements"],
  ...
  },
  {
    ...
    options: ["Makes variable readonly", "Makes all properties readonly", "Creates constant", "Freezes object"],
  ...
  },
  {
    ...
    options: ["Picks array item", "Creates type with only specified properties", "Selects values", "Filters type"],
  ...
  },
  {
    ...
    options: ["Omits values", "Creates type without specified properties", "Removes items", "Excludes type"],
  ...
  },
  {
    ...
    options: ["Audio record", "Creates object type with keys K and values V", "Records data", "Creates array"],
  ...
  },
  {
    ...
    options: ["Excludes values", "Removes types from union", "Filters array", "Excludes properties"],
  ...
  },
  {
    ...
    options: ["Extracts values", "Keeps only types present in both", "Filters items", "Gets subset"],
  ...
  },
  {
    ...
    options: ["Checks null", "Removes null and undefined from type", "Validates non-null", "Creates non-null"],
  ...
  },
  {
    ...
    options: ["If statement type", "Type that depends on condition: T extends U ? X : Y", "Ternary type", "Optional type"],
  ...
  },
  {
    ...
    options: ["Return statement", "Extracts return type of function type", "Returns type", "Creates return type"],
  ...
  },
  {
    ...
    options: ["Function parameters", "Extracts parameter types as tuple", "Parameter list", "Param type"],
  ...
  },
  {
    ...
    options: ["Math intersection", "Combines multiple types with &", "Common properties only", "Type overlap"],
  ...
  },
  {
    ...
    options: ["File merging", "Multiple declarations combine into one", "Import merging", "Type combining"],
  ...
  },
  {
    ...
    options: ["Type inference", "Captures type within conditional type", "Guesses type", "Extracts type"],
  ...
  },
  {
    ...
    options: ["Discrimination", "Union with common literal property for narrowing", "Tagged type", "Labeled union"],
  ...
  },
  {
    ...
    options: ["Satisfaction check", "Validates expression matches type without widening", "Type assertion", "Type validation"],
  ...
  },
  {
    ...
    options: ["Constant values", "Enum inlined at compile time", "Readonly enum", "Final enum"],
  ...
  },
  {
    ...
    options: ["Declaration", "Tells TS something exists without implementation", "Creates variable", "Defines type"],
  ...
  },
  {
    ...
    options: ["Variable name", "Way to organize code and avoid naming conflicts", "Module type", "Scope container"],
  ...
  },
  {
    ...
    options: ["Comment", "Reference other files or types: /// <reference />", "Type definition", "Import syntax"],
  ...
  },
  {
    ...
    options: ["Null validation", "Compiler option making null/undefined explicit", "Null removal", "Null safety"],
  ...
  },
  {
    ...
    options: ["Same thing", "Interfaces can be extended/merged, types are more flexible", "Types are deprecated", "Interfaces are faster"],
  ...
  },
  {
    ...
    options: ["Removes any", "Error when type is implicitly any", "Disables any", "Explicit any only"],
  ...
  },
  {
    ...
    options: ["Conceptual class", "Class that cannot be instantiated directly", "Hidden class", "Base class only"],
  ...
  },
  {
    ...
    options: ["private only", "public, private, protected", "internal, external", "open, closed"],
  ...
  },
  {
    ...
    options: ["Overwrite", "Explicitly marks method override of parent", "Replace", "Extend"],
  ...
  },
  {
    ...
    options: ["Constructor definition", "new (): Type - describes constructable", "Class constructor", "Factory type"],
  ...
  },
  {
    ...
    options: ["Multiple implementations", "Multiple call signatures for one function", "Function copy", "Parallel functions"],
  ...
  // ============ ADVANCED (71-100) ============
  {
    ...
    options: ["String template", "Type using template string syntax", "Generic string", "Pattern type"],
  ...
  },
  {
    ...
    options: ["Internal strings", "Built-in types: Uppercase, Lowercase, Capitalize, Uncapitalize", "String methods", "Regex types"],
  ...
  },
  {
    ...
    options: ["Loop type", "Type that references itself", "Nested type", "Chain type"],
  ...
  },
  {
    ...
    options: ["Current object", "Polymorphic this type returning same class", "Self reference", "Instance type"],
  ...
  },
  {
    ...
    options: ["This type definition", "Marker interface to set this type in object literal", "Context type", "Self type"],
  ...
  },
  {
    ...
    options: ["Assertion", "Narrows type for rest of scope: asserts x is string", "Check function", "Validation return"],
  ...
  },
  {
    ...
    options: ["Instance creation", "Extracts instance type from class constructor type", "Object type", "Constructor return"],
  ...
  },
  {
    ...
    options: ["Constructor args", "Extracts constructor parameter types", "Build parameters", "Init args"],
  ...
  },
  {
    ...
    options: ["Type difference", "How type parameters behave with inheritance", "Type range", "Type flexibility"],
  ...
  },
  {
    ...
    options: ["Input/output", "Control variance: in is contravariant, out is covariant", "Direction", "Flow control"],
  ...
  },
  {
    ...
    options: ["Logo type", "Nominal type using unique symbol", "Named type", "Labeled type"],
  ...
  },
  {
    ...
    options: ["Same thing", "object is non-primitive, Object/any object, {} is empty object type", "Different cases", "Object is deprecated"],
  ...
  },
  {
    ...
    options: ["Module import", "Describes shape of external module: declare module 'name'", "Module export", "Module type"],
  ...
  },
  {
    ...
    options: ["File links", "TypeScript feature for managing multi-project builds", "Import references", "Dependency graph"],
  ...
  },
  {
    ...
    options: ["Combination", "Enables project references and incremental builds", "Merged config", "Combined compilation"],
  ...
  },
  {
    ...
    options: ["Index validation", "Adds undefined to indexed access types", "Array check", "Object access check"],
  ...
  },
  {
    ...
    options: ["Exact matching", "Distinguishes missing property from undefined value", "Strict optional", "Property precision"],
  ...
  },
  {
    ...
    options: ["Distributed type", "Conditional type that distributes over unions", "Union distribution", "Type spreading"],
  ...
  },
  {
    ...
    options: ["Use any", "Wrap in tuple: [T] extends [U]", "Use never", "Add constraint"],
  ...
  },
  {
    ...
    options: ["Async wait", "Unwraps Promise types recursively", "Pending type", "Resolved type"],
  ...
  },
  {
    ...
    options: ["No inference", "Prevents type inference from that position", "No type", "Skip inference"],
  ...
  },
  {
    ...
    options: ["Import statement", "Automatic resource disposal with Symbol.dispose", "Using modules", "Resource usage"],
  ...
  },
  {
    ...
    options: ["Constant generic", "<const T> infers literal types for T", "Readonly parameter", "Fixed type"],
  ...
  },
  {
    ...
    options: ["Type import", "Import that's removed in compiled JS", "Type only import", "All of the above"],
  ...
  },
  {
    ...
    options: ["Mode resolution", "Specify CJS or ESM resolution for type import", "Import mode", "Module resolution"],
  ...
  },
  {
    ...
    options: ["Module path", "How TypeScript resolves module imports", "Module type", "Import resolution"],
  ...
  },
  {
    ...
    options: ["Verbose mode", "Requires explicit 'import type' for type-only imports", "Exact module syntax", "Strict imports"],
  ...
  },
  {
    ...
    options: ["Type export", "export type { T } that's erased in JS", "Interface export", "Type definition"],
  ...
  },
  {
    ...
    options: ["Separate compilation", "Ensures files can be compiled independently", "Module isolation", "Import isolation"],
  ...
  },
  {
    ...
    options: ["Skip library", "Skips type checking declaration files", "Library bypass", "Type skip"],
